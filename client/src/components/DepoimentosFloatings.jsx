...
import ft5 from '../assets/fts/ft5.png';
  ...
  return (
    <div className="relative py-16 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <h2 className="text-4xl md:text-5xl font-extrabold text-red-700 text-center mb-16">
          ...
          {fotos.map((foto, index) => (
            <motion.div
              ...
              style={{
                ...
                padding: '3px', 
                borderRadius: '18px', 
                boxShadow: '0 0 20px rgba(255, 26, 26, 0.5), 0 0 30px rgba(255, 26, 26, 0.3)',
              }}
